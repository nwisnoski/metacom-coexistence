...
div_part %>% 
  ...
  ggsave("figures/aboveground_diversity_partitioning_equal2000_ext005.pdf", width = 8, height = 6)
...
div_part %>% 
  ...
  scale_x_log10() +
  theme(legend.position = "top") +
  ggsave("figures/belowground_diversity_partitioning_equal2000_ext005.pdf", width = 8, height = 6)
